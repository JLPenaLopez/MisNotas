...
class CartTestTwo: XCTestCase {
	...
	override func setUp() {
		...
		super.setUp();
		mazda = Car(type: .Sport, transmissionMode: .Drive);
    ...
    func testCaseCart() {
		...
		XCTAssertFalse(mercedesBenz.distance > mazda.distance);
		//Entonces se valida si el mercedez y el mazda van a la misma velocidad
		XCTAssertEqual(mercedesBenz.speed, mazda.speed, "mercedesBenz.speed >> \(mercedesBenz.speed)km/h y mazda.speed >> \(mazda.speed)km/h");
